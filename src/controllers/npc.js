...
export default class NPC {
  constructor(game, name, x, y, strategy) {
    ...
    if (strategy === "line") {
    ...
    } else if (strategy === "long line") {
      this.points = [
        { x: spawnX, y: spawnY },
        { x: spawnX - 64, y: spawnY },
        { x: spawnX - 128, y: spawnY },
        { x: spawnX - 192, y: spawnY },
        { x: spawnX - 256, y: spawnY },
        { x: spawnX - 320, y: spawnY },
        { x: spawnX - 384, y: spawnY },
        { x: spawnX - 320, y: spawnY },
        { x: spawnX - 256, y: spawnY },
        { x: spawnX - 192, y: spawnY },
        { x: spawnX - 128, y: spawnY },
    ...
    } else if (strategy === "vertical medium line") {
      this.points = [
        { x: spawnX, y: spawnY },
        { x: spawnX, y: spawnY + 64 },
        { x: spawnX, y: spawnY + 128 },
        { x: spawnX, y: spawnY + 184 },
        { x: spawnX, y: spawnY + 128 },
        { x: spawnX, y: spawnY + 64 }
      ];
    } else if (strategy === "u") {
      this.points = [
        ...
        { x: spawnX, y: spawnY + 64 },
        { x: spawnX + 64, y: spawnY + 64 },
        { x: spawnX + 128, y: spawnY + 64 },
        { x: spawnX + 184, y: spawnY + 64 },
        { x: spawnX + 256, y: spawnY + 64 },
        { x: spawnX + 256, y: spawnY + 10 },
        { x: spawnX + 256, y: spawnY + 64 },
        { x: spawnX + 184, y: spawnY + 64 },
        { x: spawnX + 128, y: spawnY + 64 },
        { x: spawnX + 64, y: spawnY + 64 },
