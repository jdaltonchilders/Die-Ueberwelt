...
export default class GreenHome extends Phaser.State {
  ...
  create() {
    ...
    // Create the Map
    this.map = this.game.add.tilemap("greenHome");
    ...
    if (store.eatenFromHouses.indexOf("Green") === -1) this.food = new Food(this.game, 220, 100, this.player.sprite, "Green");
