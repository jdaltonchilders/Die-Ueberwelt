...
export default class BlackHome extends Phaser.State {
    constructor() {
    ...
    preload() {
        // Load Tilemap
        this.game.load.tilemap('blackHome', 'assets/maps/blackHome.json', null, Phaser.Tilemap.TILED_JSON);
    ...
    create() {
        ...
        // Create the Map
        this.map = this.game.add.tilemap('blackHome');
