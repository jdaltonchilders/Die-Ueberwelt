...
export default class AudioManager {
    ...
    preload() {
        // Landscape Audio
        this.game.load.audio('introBackground', 'assets/audio/landscape/city_ruins_shade.ogg');
        this.game.load.audio('mainBackground', 'assets/audio/landscape/the_weight_of_the_world.ogg');
        this.game.load.audio('forestBackground', 'assets/audio/landscape/memories_of_dust.ogg');
        this.game.load.audio('dungeonBackground', 'assets/audio/landscape/wretched_weaponry.ogg');
        this.game.load.audio('bossBackground', 'assets/audio/landscape/a_beautiful_song.ogg');
        this.game.load.audio('victoryBackground', 'assets/audio/landscape/the_weight_of_the_world.ogg');
        this.game.load.audio('deathBackground', 'assets/audio/landscape/the_sound_of_the_end.ogg');
